...
var
  ...
  begin
       FOR i := 1 TO n do
       begin
         if lengths[from-1] > 0 then
         begin
            lengths[from-1] := lengths[from-1] - 1;
            boxes[dest-1][lengths[dest-1]] := boxes[from-1][lengths[from-1]];
            boxes[from-1][lengths[from-1]] := '_';
            lengths[dest-1] := lengths[dest-1] + 1;
         end;
       end;
  end;
